...
grid = np.arange(0.8,8.0,0.001).reshape(-1,1)
kT = 1.5
...
X_train, X_test, y_train, y_test = train_test_split(grid, fes, random_state=95231, shuffle=True, test_size=0.1)
...
grid = np.arange(0.8,8.01,0.01).reshape(-1,1)
